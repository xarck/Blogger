...
import { ManagePublishedBlogCard, ManageDraftBlogPost } from "../components/ManageBlogCardComponent";
...
const ManageBlogs = () => {
    ...
    return (
        <>
            ...
            <InPageNavigation routes={["PublishedBlogs", "Drafts"]} defaultActiveIndex={activeTab != "draft" ? 0 : 1}>
                {
                    // for  published blogs
                    blogs == null ? <Loader /> :
                        blogs.results.length ?
                            <>
                                {
                                    blogs.results.map((blog, i) => {
                                        return <AnimationWrapper key={i} transition={{ delay: i * 0.05 }}>
                            ...
                            : <NoDataComponent message="No published blogs" />
                }

                {
                    ...
                    drafts == null ? <Loader /> :
                        drafts.results.length ?
                            ...
                            : <NoDataComponent message="No draft blogs" />
                }
